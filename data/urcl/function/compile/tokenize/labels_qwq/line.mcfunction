...
# Check if Comment/Label/Define
data modify storage urcl:temp first_char set string storage urcl:temp line 0 1
execute if score #line urcl.temp matches 2.. if data storage urcl:temp {first_char:"."} run function urcl:compile/tokenize/labels_qwq/add_label
execute if score #line urcl.temp matches 1.. unless data storage urcl:temp {first_char:"."} unless data storage urcl:temp {first_char:"#"} unless data storage urcl:temp {first_char:";"} run function urcl:compile/tokenize/labels_qwq/jump_op with storage urcl:temp
