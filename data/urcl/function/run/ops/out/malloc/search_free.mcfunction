...
execute store result storage urcl:temp malloc.index int 1 store result score out= urcl.runtime run scoreboard players get &prev_next_malloc urcl.temp
...
data modify storage urcl:temp out_val set value 0
