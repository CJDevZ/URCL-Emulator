...
execute store result score #1 urcl.math store result score #2 urcl.math run function urcl:run/arg/get/_ with storage urcl:temp
scoreboard players operation #2 urcl.math *= -1 __int__
