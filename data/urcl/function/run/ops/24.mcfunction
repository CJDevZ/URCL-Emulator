...
execute if score #1 urcl.math = #2 urcl.math store result storage urcl:runtime curLine int 1 run return run scoreboard players add @s urcl.runtime.curLine 1
