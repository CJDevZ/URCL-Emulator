...
execute store result score out= urcl.runtime run function urcl:run/arg/get/register/pc1 with storage urcl:temp
execute if score out= urcl.runtime matches ..-1 run scoreboard players operation out= urcl.runtime *= -1 __int__
