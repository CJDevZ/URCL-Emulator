...
execute unless score #1 urcl.math matches 0.. store result storage urcl:runtime curLine int 1 run return run scoreboard players add @s urcl.runtime.curLine 1
