execute store result score #left strlib store result score #string strlib store result score &char strlib store result storage strlib:temp left int 1 store result storage strlib:temp left1 int 1 run data get storage strlib:in string
execute unless score #left strlib matches 1.. run return run data modify storage strlib:out split set value [""]
data modify storage strlib:temp string set from storage strlib:in string
